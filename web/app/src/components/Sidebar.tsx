...
import { LayoutGrid, MessageSquare, Users, Workflow, CreditCard, LogOut, Menu, X, Plus, Check, ChevronsUpDown, Home, HelpCircle, User } from "lucide-react";
          ...
          <div className="relative w-64 max-w-[80%] h-full bg-white px-4 py-5 flex flex-col justify-between shadow-xl">
            <div>
              ...
              <nav className="flex flex-col gap-1">
                ...
                <NavItem icon={Users} label="People" to="/app/board" onClick={() => setOpen(false)} />
      ...
      <aside className="w-60 shrink-0 border-r border-line px-4 py-5 hidden md:flex md:flex-col justify-between">
        <div>
          ...
          <nav className="flex flex-col gap-1">
            ...
            <NavItem icon={Users} label="People" to="/app/board" />
